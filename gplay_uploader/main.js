...
async function main(){    
    ...
    commander.requiredOption("-t, --target_track <track name>", "Target track name ('com.gameinsight.gplay.mmanor' for ex.)");
    commander.requiredOption("-p, --package_name <package_name>", "Package name ('internal' for ex.)");
